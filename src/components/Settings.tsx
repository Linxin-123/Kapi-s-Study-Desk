    ...
    <form onSubmit={handleSubmit} className="space-y-6 max-w-2xl mx-auto">
        ...
        <div className="flex items-center justify-between p-3 bg-amber-50/40 rounded-2xl border border-[#FFEADA] mt-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[10px] text-[#A0836D]">Enable Text-to-Speech to hear your companion read messages aloud in a gentle voice.</p>
            </div>
          </div>
          <button
            type="button"
      ...
      <div className="bg-white border border-[#FFDEC9] rounded-3xl p-6 shadow-xs space-y-4">
        ...
        <div className="p-4 bg-amber-50/50 rounded-2xl border border-[#FFDEC9] space-y-2">
          <h4 className="text-xs font-bold text-[#725442] flex items-center gap-1.5">
            ...
            Quick Training Guide (5 Classes)
          </h4>
          <ol className="text-[10px] text-[#A0836D] space-y-1 list-decimal list-inside leading-relaxed pl-1">
            ...
            <li>
              Add five custom class labels: <code className="bg-amber-100/50 px-1 rounded">focused</code> (studying/reading),{' '}
              <code className="bg-amber-100/50 px-1 rounded">phone</code> (looking down/holding a smartphone),{' '}
              <code className="bg-amber-100/50 px-1 rounded">away</code> (empty chair/out of frame),{' '}
              <code className="bg-amber-100/50 px-1 rounded">tired</code> (resting head/sleeping), and{' '}
              <code className="bg-amber-100/50 px-1 rounded">stretch</code> (active stretching).
            </li>
      ...
      <div className="bg-white border border-[#FFDEC9] rounded-3xl p-6 shadow-xs space-y-4">
        ...
        <p className="text-[11px] text-[#A0836D] leading-relaxed -mt-2">
          ...
          (with a voice message) to stand up, stretch, and drink some water.
        </p>
        ...
        <div className={`grid grid-cols-1 md:grid-cols-2 gap-6 transition-opacity ${healthEnabled ? '' : 'opacity-40 pointer-events-none'}`}>
          ...
          <div className="space-y-2">
            ...
            />
            <p className="text-[10px] text-[#A0836D]">
              Away or stretch time under {healthBreakMinutes} min doesn't count — the timer keeps building.
            </p>
          </div>
        </div>
      </div>

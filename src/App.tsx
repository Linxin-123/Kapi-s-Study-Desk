      ...
      timerRef.current = setInterval(() => {
        ...
        if (stableState === 'focused') {
          ...
          if (updated.totalFocusTime > 0 && updated.totalFocusTime % orangeSecs === 0) {
            ...
            if (settings.chimeEnabled) playCozyChime(true);
        ...
        if (settings.healthEnabled !== false) {
          ...
          } else if (stableState === 'distracted' || stableState === 'absent') {
          ...
          if (focusSinceBreakRef.current >= focusLimit) {
            ...
            setBreakSecs(0);
            setBreakMode(true);
            if (settings.chimeEnabled) playCozyChime(false);
          ...
          >
              ...
              <div className="bg-white/90 backdrop-blur-md rounded-3xl border border-[#FFDEC9] p-5 shadow-sm flex flex-col items-center relative overflow-hidden">
                ...
                <div className="mt-5 text-center">
                  ...
                  {settings.healthEnabled !== false && sessionState !== 'idle' && (
                    <p className="text-[9px] font-bold text-[#B99C86] mt-2 leading-relaxed">
                      ⏳ break reminder in{' '}
                      <span className="font-mono text-[#8EAC50]">
                        {formatMS(Math.max(0, Math.max(5, settings.healthFocusMinutes ?? 50) * 60 - focusSinceBreakRef.current))}
                      </span>{' '}
                      of focus
                      <br />
                      rest this interval:{' '}
                      <span className="font-mono">
                        {formatMS(restAccumRef.current)} / {settings.healthBreakMinutes ?? 5}m
                      </span>
                    </p>
                  )}
                </div>

          ...
          <AnimatePresence>
            {(!running || over) && (
              <motion.div
                ...
                animate={{ opacity: 1 }}
                exit={{ opacity: 0 }}
                className="absolute inset-0 bg-[#FFFDF9]/85 backdrop-blur-[2px] rounded-2xl flex flex-col items-center justify-center gap-2"
              >
                {over ? (
                  <>
                  ...
                  <>
                    <div className="text-3xl">🍊</div>
                    <div className="text-xs font-bold text-[#A0836D] text-center px-8">
                      Swap neighbouring tiles to line up 3 or more. 90 seconds — go!
                    </div>
